...
class FOnlineSessionEpic : public IOnlineSession 
{
...
public:
	...
	virtual bool DestroySession(FName SessionName, const FOnDestroySessionCompleteDelegate& CompletionDelegate) override;
	...
	virtual bool RegisterPlayers(FName SessionName, const TArray<TSharedRef<const FUniqueNetId>>& Players, bool bWasInvited) override;
